...
def logo():
	os.system("clear")
	print("""\x1b[0;32m╔════════════════════════════════════════════╗
\x1b[0;33m║WELCOME TO RIDOY ROUDRO OFFICIAL  [RIDOY].  ║
\x1b[0;33m║       #TOOL AUTHOR [R•I•D•O•Y] RIDOY ROUDRO. ║
\x1b[0;33m╚════════════════════════════════════════════╝
\x1b[0;33m ---------------------------------------------
\x1b[0;33m╔════════════════════════════════════════════╗
\x1b[0;33m║#YOUTUBE : https://youtube.com/channel/UC7G_z1s_pWgrE_BUr__8qtQ .  ║
\x1b[0;33m║#FACEBOOK : NAME [ SHAMSUL ALAM ].       ║
\x1b[0;33m║#GITHUB : https://github.com/RidoyRoudro .   ║
\x1b[0;33m║#WHATSAPP : XXXXXXXXXXXX.                   ║
\x1b[0;33m╚════════════════════════════════════════════╝""")
def login():
	os.system("clear")
	try:
